...
def main(args):
    ...
    with mlflow.start_run():
        ...
        model = XGBClassifier(
            ...
            n_estimators=401,        
            learning_rate=0.03783657788328709,    
            max_depth=4,           
            
            # Regularization parameters
            subsample=0.9996429951979213,         
            colsample_bytree=0.8990760197764236,  
            
            min_child_weight=5,
            gamma=4.015678704889002,
            reg_alpha=4.052644478839689, 
            reg_lambda=1.7841572503094845,
